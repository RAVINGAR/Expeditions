...
class LootTable @OptIn(ExperimentalTypeInference::class) constructor(private val quantity: IntRange, @BuilderInference builderAction: MutableList<LootItem>.() -> Unit) :
    LootHolder {
